/*
    Dark Veil - Exact Port
    Source: https://github.com/DavidHDev/react-bits/blob/main/src/content/Backgrounds/DarkVeil/DarkVeil.jsx
*/
...
if (!gl) {
    ...
    function render(time) {
        ...
        gl.uniform1f(uHueShift, config.hueShift);
        gl.uniform1f(uNoise, config.noiseIntensity);
        gl.uniform1f(uScan, config.scanlineIntensity);
        gl.uniform1f(uScanFreq, config.scanlineFrequency);
